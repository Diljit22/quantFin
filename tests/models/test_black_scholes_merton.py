...
def test_SDE_not_implemented():
    """Test that calling SDE raises NotImplementedError."""
    bsm = BlackScholesMerton(sigma=0.2)
    with pytest.raises(NotImplementedError):
        bsm.SDE()


def test_S_t_not_implemented():
    """Test that calling S_t raises NotImplementedError."""
    bsm = BlackScholesMerton(sigma=0.2)
    with pytest.raises(NotImplementedError):
        bsm.S_t()
